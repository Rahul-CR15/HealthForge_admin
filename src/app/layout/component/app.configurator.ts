...
@Component({
    ...
    template: `
        <div class="flex flex-col gap-4">
            ...
            <div>
                <span class="text-sm text-muted-color font-semibold">Custom Color</span>
                <div class="pt-2">
                    <p-colorPicker [ngModel]="customColor" (ngModelChange)="onCustomColorChange($event)" [inline]="false" />
                    <span class="ml-2 text-xs text-muted-color">{{ customColor }}</span>
                </div>
            </div>
            <div>
...
export class AppConfigurator {
    ...
    customColor: string = '#10b981';

    onCustomColorChange(color: string) {
        this.customColor = color;
        // In a real scenario, we'd generate a palette here.
        // For now, let's at least update the primary 500.
        updatePreset({
            semantic: {
                primary: {
                    50: color,
